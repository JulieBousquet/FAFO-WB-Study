...
use "$data_2020_temp/02_FAFO2020_HH_RSI.dta", clear
...
import excel "$data_master\FAFO2020_PostCoding_Industry.xlsx", sheet("MAIN") firstrow clear
*gen id = _n 
...
*save "$data_2020_final/02_FAFO2020_Clean.dta", replace
save "$data_2020_final/01_FAFO2020_Clean.dta", replace

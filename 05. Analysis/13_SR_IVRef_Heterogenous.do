...
****************************************************
     ...
     coefplot (REFGEN_YD_employed_olf_$rp), bylabel(Employed)  ///
             ...
             || (REFGEN_YD_formal_$rp), bylabel(Formal) ///
...
coefplot (REFURB_YD_employed_olf_$rp), bylabel(Employed)  ///
             ...
             || (REFURB_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
****************************************************
    ...
    coefplot (REFEDU_YD_employed_olf_$rp), bylabel(Employed)  ///
             ...
             || (REFEDU_YD_formal_$rp), bylabel(Formal) ///
             || , drop(_Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
coefplot      (WEMP_YD_act_ag_$rp), bylabel(Activity: Agricultural)  ///
             ...
             || (WEMP_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
coefplot      (TEMP_YD_act_ag_$rp), bylabel(Activity: Agricultural)  ///
             ...
             || (TEMP_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
coefplot      (SE_YD_act_ag_$rp), bylabel(Activity: Agricultural)  ///
             ...
             || (SE_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
coefplot      (AG_YD_lfp_empl_$rp), bylabel(Wage Employee)  ///
             ...
             || (AG_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
coefplot      (MANUF_YD_lfp_empl_$rp), bylabel(Wage Employee)  ///
             ...
             || (MANUF_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
coefplot      (COM_YD_lfp_empl_$rp), bylabel(Wage Employee)  ///
             ...
             || (COM_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
coefplot      (SERV_YD_lfp_empl_$rp), bylabel(Wage Employee)  ///
             ...
             || (SERV_YD_formal_$rp), bylabel(Formal) ///
             || , drop( _Iyear_2016 $district _cons $SR_controls) ///
              xline(0) msymbol(d) ///
              label subtitle(, size(vsmall) fcolor(white) nobox ) ///
             xlabel("") ylabel(1 "Treat" 2 "Inter" 3 "VoI") ///
...
**** OLS *****
  foreach outcome of global SR_outcome_3m {
    qui xi: reg `outcome' $SR_treat_var_ref $inter_het_var $het_var ///
                age age2 ///
                i.district_iid i.year  ///
            [pw = $SR_weight],  ///
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store REFGEN_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $REFGEN_YD3_p1 $REFGEN_YD3_p2 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop(age age2 _Iyear_2016  $district ///
        _cons)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
...
preserve
  foreach outcome of global SR_outcome_3m {
      ...
      estimates table,  k($SR_treat_var_ref  $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store REFGEN_YI3_`outcome', title(Model `outcome')
...
ereturn list
mat list e(b)
estout $REFGEN_YI3_p1 $REFGEN_YI3_p2 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop(age age2 _cons)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
**** OLS *****
  foreach outcome of global SR_outcome_3m {
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store REFURB_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $REFURB_YD3_p1 $REFURB_YD3_p2 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016  $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store REFURB_YI3_`outcome', title(Model `outcome')
...
ereturn list
mat list e(b)
estout $REFURB_YI3_p1 $REFURB_YI3_p2 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
**** OLS *****
  foreach outcome of global SR_outcome_3m {
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store REFEDU_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $REFEDU_YD3_p1 $REFEDU_YD3_p2 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store REFEDU_YI3_`outcome', title(Model `outcome')
...
ereturn list
mat list e(b)
estout $REFEDU_YI3_p1 $REFEDU_YI3_p2 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
esttab $REFGEN_YD3_p1   /// 
      using "$out_analysis/SR_REF_HET_reg_MERGE_p1_3m.tex",  ///
      prehead("\begin{tabular}{l*{6}{c}} \toprule ") ///
      posthead("& & & & & &  \\  & b (se) & b (se) & b (se) & b (se) & b (se) & b (se)  \\ \midrule \midrule \multicolumn{7}{c}{\textit{\textbf{GENDER}}} \\ \multicolumn{7}{c}{\textit{PANEL A: District and Year Fixed Effects}} \\  \midrule ") ///
      fragment replace label ///
    drop($district _cons age age2 _Iyear_2016)   ///
...
esttab $REFGEN_YD3_p2   /// 
      using "$out_analysis/SR_REF_HET_reg_MERGE_p2_3m.tex",  ///
      prehead("\begin{tabular}{l*{8}{c}} \toprule ") ///
      posthead("& & & & & & & & \\ & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se)  \\ \midrule \midrule \multicolumn{9}{c}{\textit{\textbf{GENDER}}} \\ \multicolumn{9}{c}{\textit{PANEL A: District and Year Fixed Effects}} \\  \midrule ") ///
      fragment replace label ///
    drop($district _cons age age2 _Iyear_2016)   ///
...
**** OLS *****
  foreach outcome of global SR_outcome_HET_LFP_3m {
    qui xi: reg `outcome' $SR_treat_var_ref $inter_het_var $het_var ///
                $SR_controls  ///
                i.district_iid i.year  ///
            [pw = $SR_weight],  ///
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store WEMP_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $SR_outcome_WEMP_YD3 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_HET_LFP_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store WEMP_YI3_`outcome', title(Model `outcome')
...
**** OLS *****
  foreach outcome of global SR_outcome_HET_LFP_3m {
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store TEMP_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $SR_outcome_TEMP_YD3 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_HET_LFP_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store TEMP_YI3_`outcome', title(Model `outcome')
...
**** OLS *****
  foreach outcome of global SR_outcome_HET_LFP_3m {
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store SE_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $SR_outcome_SE_YD3 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_HET_LFP_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store SE_YI3_`outcome', title(Model `outcome')
...
esttab $SR_outcome_WEMP_YD3   /// 
      using "$out_analysis/SR_REF_HET_reg_MERGE_LFP_3m.tex",  ///
      prehead("\begin{tabular}{l*{8}{c}} \toprule ") ///
      posthead("& & & & & & & & \\  & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) \\ \midrule \midrule \multicolumn{9}{c}{\textit{\textbf{WAGE EMPLOYMENT}}} \\ \multicolumn{9}{c}{\textit{PANEL A: District and Year Fixed Effects}} \\  \midrule ") ///
      fragment replace label ///
      drop($district _cons $SR_controls _Iyear_2016)   ///
...
**** OLS *****
  foreach outcome of global SR_outcome_HET_ACT_3m {
    qui xi: reg `outcome' $SR_treat_var_ref $inter_het_var $het_var ///
                $SR_controls  ///
                i.district_iid i.year  ///
            [pw = $SR_weight],  ///
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store AG_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $SR_outcome_AG_YD3 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_HET_ACT_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store AG_YI3_`outcome', title(Model `outcome')
...
**** OLS *****
  foreach outcome of global SR_outcome_HET_ACT_3m {
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store MANUF_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $SR_outcome_MANUF_YD3 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_HET_ACT_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store MANUF_YI3_`outcome', title(Model `outcome')
...
**** OLS *****
  foreach outcome of global SR_outcome_HET_ACT_3m {
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store COM_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $SR_outcome_COM_YD3 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_HET_ACT_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store COM_YI3_`outcome', title(Model `outcome')
...
**** OLS *****
  foreach outcome of global SR_outcome_HET_ACT_3m {
    ...
    estimates table, k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) b(%7.4f) 
    estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
    estimates store SERV_YD3_`outcome', title(Model `outcome')
  }

ereturn list
mat list e(b)
estout $SR_outcome_SERV_YD3 /// 
      , cells(b(star fmt(%9.3f)) se(par fmt(%9.3f)) F(par fmt(%9.3f))) ///
        drop( _Iyear_2016 $district _cons $SR_controls)   ///
   legend label varlabels(_cons constant) starlevels(* 0.1 ** 0.05 *** 0.01)  ///
   stats(N r2, fmt(0 2) label(N R-sqr))
...
preserve
  foreach outcome of global SR_outcome_HET_ACT_3m {
      ...
      estimates table,  k($SR_treat_var_ref $inter_het_var $het_var) star(.1 .05 .01) 
      estimates table, b(%7.4f) se(%7.4f) stats(N r2_a) k($SR_treat_var_ref $inter_het_var $het_var) 
      estimates store SERV_YI3_`outcome', title(Model `outcome')
...
esttab $SR_outcome_AG_YD3   /// 
      using "$out_analysis/SR_REF_HET_reg_MERGE_ACT_p1_3m.tex",  ///
      prehead("\begin{tabular}{l*{8}{c}} \toprule ") ///
      posthead("& & & & & & & & \\  & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) \\ \midrule \midrule \multicolumn{9}{c}{\textit{\textbf{AGRICULTURE}}} \\ \multicolumn{9}{c}{\textit{PANEL A: District and Year Fixed Effects}} \\  \midrule ") ///
      fragment replace label ///
    drop($district _cons $SR_controls _Iyear_2016)   ///
...
esttab $SR_outcome_SERV_YD3   /// 
      using "$out_analysis/SR_REF_HET_reg_MERGE_ACT_p2_3m.tex",  ///
      prehead("\begin{tabular}{l*{8}{c}} \toprule ") ///
      posthead("& & & & & & & & \\  & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) & b (se) \\ \midrule \midrule \multicolumn{9}{c}{\textit{\textbf{SERVICES}}} \\ \multicolumn{9}{c}{\textit{PANEL A: District and Year Fixed Effects}} \\  \midrule ") ///
      fragment replace label ///
    drop($district _cons $SR_controls _Iyear_2016)   ///

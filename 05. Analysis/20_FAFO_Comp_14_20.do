...
use "$data_2014_final/01_FAFO2014_Clean.dta", clear
desc 
...
save "$data_temp/01_FAFO_2014_Harmo20.dta", replace
...
save "$data_temp/02_FAFO_2020_Harmo14.dta", replace

use "$data_temp/02_FAFO_2020_Harmo14.dta", clear 
append using "$data_temp/01_FAFO_2014_Harmo20.dta" 

tab year 

save "$data_final/01_FAFO_14_20.dta", replace

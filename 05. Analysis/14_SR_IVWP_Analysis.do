...
esttab $WPOLS_YD_uncond   /// 
      using "$out_analysis/SR_WP_reg_uncond_MERGE.tex",  ///
...
esttab $WPOLS_YD_cond   /// 
      using "$out_analysis/SR_WP_reg_cond_MERGE.tex",  ///
